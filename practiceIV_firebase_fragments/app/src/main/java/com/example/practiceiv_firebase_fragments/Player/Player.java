...
public class Player implements Parcelable {
    ...
    //default constructor
    public Player(Long player_id, String player_name, String player_description, String player_position, int years_played, int player_age, int imageResourceID, int on_the_roster){
